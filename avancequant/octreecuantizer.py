...
def showimage():
    flm=filedialog.askopenfilename(initialdir=os.getcwd(),title="Selec Image File", filetypes=(("JPG File","*.jpg"),("PNG File","*.png"),("All Files","*.*")))
    img=Image.open(flm)
...
def mostrarpaleta():
    ...
    img2 = cv2.imwrite('nuevopanda.jpg',pixelsPaleta)
    ...
    cv2.imwrite("salidapanda.png",imagenResul)
...
#btn = Button(frm, text= "Elegir imagen",command=showimage)
imagen = showimage()
...
root.title("OCTREE: Cuantizacion de color")
